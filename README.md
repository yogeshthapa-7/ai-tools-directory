...
<div align="center" id="screenshots">
  <img src="ai-tools/public/screenshot1.png" alt="Home Page" width="800" style="border-radius: 10px; margin-bottom: 20px;" />
  <p><em>Home Page - A visual grid of top AI tools</em></p>
  <br />
  
  <img src="ai-tools/public/screenshot2.png" alt="Explore Page" width="800" style="border-radius: 10px; margin-bottom: 20px;" />
  <p><em>Explore Page - Advanced filtering and search</em></p>
  <br />

  <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
    <img src="ai-tools/public/screenshot3.png" alt="Tool Details" width="45%" style="border-radius: 10px;" />
    <img src="ai-tools/public/screenshot4.png" alt="Bookmarks" width="45%" style="border-radius: 10px;" />
  </div>
  <p><em>Tool Details & Bookmarks Manager</em></p>
  <br/>

   <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
    <img src="ai-tools/public/screenshot5.png" alt="Submit Tool" width="45%" style="border-radius: 10px;" />
    <img src="ai-tools/public/screenshot6.png" alt="Mobile View" width="45%" style="border-radius: 10px;" />
  </div>
